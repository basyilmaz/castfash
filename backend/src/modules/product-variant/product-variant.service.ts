...
export class ProductVariantService {
    ...
    async updateStock(id: number, quantity: number, operation: 'set' | 'add' | 'subtract') {
        ...
        this.logger.log(`Updated stock for variant ${id}: ${operation} ${quantity}`);
        return variant;
    }
    ...
    async createVariantMatrix(
        ...
        this.logger.log(`Created ${created.count} variants for product ${productId}`);
