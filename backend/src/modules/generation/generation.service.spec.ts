...
describe('GenerationService', () => {
    ...
    describe('generate', () => {
        ...
        beforeEach(() => {
            prismaService.product.findFirst = jest.fn().mockResolvedValue(mockProduct);
            prismaService.organization.findUnique = jest.fn().mockResolvedValue(mockOrganization);
            prismaService.modelProfile.findFirst = jest.fn().mockResolvedValue(mockModelProfile);
            prismaService.scenePreset.findFirst = jest.fn().mockResolvedValue(mockScenePreset);
        ...
        it('should throw NotFoundException if product not found', async () => {
            ...
            await expect(
                service.generate(1, 1, generateDto as any),
            ).rejects.toThrow(NotFoundException);
        });

        it('should throw BadRequestException if no images requested', async () => {
            await expect(
                service.generate(1, 1, { ...generateDto, frontCount: 0, backCount: 0 } as any),
    ...
    describe('getRequest', () => {
        ...
        it('should return generation request', async () => {
            prismaService.generationRequest.findFirst = jest.fn().mockResolvedValue(mockRequest);
        ...
        it('should throw NotFoundException if request not found', async () => {
            prismaService.generationRequest.findFirst = jest.fn().mockResolvedValue(null);

            await expect(service.getRequest(1, 999)).rejects.toThrow(NotFoundException);
        });
    ...
    describe('listRecent', () => {
        it('should return recent generation requests', async () => {
            ...
            prismaService.generationRequest.findMany = jest.fn().mockResolvedValue(mockRequests);
        ...
        it('should use default take value', async () => {
            prismaService.generationRequest.findMany = jest.fn().mockResolvedValue([]);
    ...
    describe('listGenerations', () => {
        it('should return paginated generations list', async () => {
            ...
            const result = await service.listGenerations(1, { page: 1, pageSize: 20 });
    ...
    describe('getGenerationDetail', () => {
        it('should return detailed generation info', async () => {
            ...
            prismaService.generationRequest.findFirst = jest.fn().mockResolvedValue(mockDetail);
        ...
        it('should throw NotFoundException if not found', async () => {
            ...
            await expect(service.getGenerationDetail(1, 999)).rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('runBatch', () => {
        ...
        it('should throw NotFoundException if product not found', async () => {
            ...
            await expect(service.runBatch(1, batchDto as any)).rejects.toThrow(NotFoundException);
        });
    });
});
